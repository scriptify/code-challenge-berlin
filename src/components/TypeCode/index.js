...
class TypeCode extends Component {
    render() {
        return ( < div className = "App" > < header className = "App-header row middle-xs center-xs" > < div className = "App-header-contain" > < img src = {
            ...
            div > < /header > < div class = "input-contain" > <div class="row middle-xs center-xs"><div class="col-xs-12"> < img src = {
            inputPhoto
        }
        className = "inputPhoto col-xs-12"
        alt = "logo" / > < input type = "text"
        className = "col-xs-12"
        placeholder = "TYPE CODE" / > < /div>< /div > < /div > <div className="footer">< p className = "App-intro" > Questions ? Do not hesitate to < a href = "#"
        class = "contact-us" > contact us! < /a > < /p > < /div> < button className="submit" onClick = { () => {
